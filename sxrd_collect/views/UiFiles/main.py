...
class Ui_SXRDCollectWidget(object):
    def setupUi(self, SXRDCollectWidget):
        ...
        SXRDCollectWidget.resize(799, 863)
...
"}"))
        ...
        self.manual_filename_cb = QtGui.QCheckBox(self.widget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.manual_filename_cb.sizePolicy().hasHeightForWidth())
        self.manual_filename_cb.setSizePolicy(sizePolicy)
        self.manual_filename_cb.setObjectName(_fromUtf8("manual_filename_cb"))
        self.verticalLayout_2.addWidget(self.manual_filename_cb)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setContentsMargins(-1, -1, -1, 0)
        self.horizontalLayout_2.setSpacing(0)
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.manual_basename_txt = QtGui.QLineEdit(self.widget)
        self.manual_basename_txt.setMaximumSize(QtCore.QSize(200, 16777215))
        self.manual_basename_txt.setEchoMode(QtGui.QLineEdit.Normal)
        self.manual_basename_txt.setObjectName(_fromUtf8("manual_basename_txt"))
        self.horizontalLayout_2.addWidget(self.manual_basename_txt)
        self.manual_flenumber_txt = QtGui.QLineEdit(self.widget)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.manual_flenumber_txt.sizePolicy().hasHeightForWidth())
        self.manual_flenumber_txt.setSizePolicy(sizePolicy)
        self.manual_flenumber_txt.setMaximumSize(QtCore.QSize(50, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.manual_flenumber_txt.setFont(font)
        self.manual_flenumber_txt.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.manual_flenumber_txt.setAlignment(QtCore.Qt.AlignCenter)
        self.manual_flenumber_txt.setObjectName(_fromUtf8("manual_flenumber_txt"))
        self.horizontalLayout_2.addWidget(self.manual_flenumber_txt)
...
"}"))
    ...
    def retranslateUi(self, SXRDCollectWidget):
        ...
        self.manual_filename_cb.setText(_translate("SXRDCollectWidget", "Manual filename", None))
        self.manual_basename_txt.setPlaceholderText(_translate("SXRDCollectWidget", "Basename", None))
        self.manual_flenumber_txt.setText(_translate("SXRDCollectWidget", "1", None))
        self.manual_flenumber_txt.setPlaceholderText(_translate("SXRDCollectWidget", "Number", None))
